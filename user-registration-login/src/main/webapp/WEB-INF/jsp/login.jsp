...
<head>
  <meta charset="UTF-8">
  <title>CodePen - CSS-Only Accessible Floating Labels Advanced Version</title>
...
<!--    <form action="" class="log-in" autocomplete="off"> -->
    <form:form method="post" id="loginForm" modelAttribute="login" action="loginProcess" class="log-in">
